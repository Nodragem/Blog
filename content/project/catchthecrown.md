...
Four teenager Prabbits - half parots / half rabbits creatures - are undertaking their "Coming-of-Age" ritual. They are spawned in an arena, in which there is a crown and a timer. Once the crown is picked up by a Prabbit, coins, diamonds and rubies appear across the level. Only the Prabbit with the crown can collect them. 
...
## Customization and Notes:
 ...
 - the assets are accessible and can be modified, that means you can add new levels and change the animations or sounds if you wanted too,
